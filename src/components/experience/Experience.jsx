...
export default function Experience() {
    ...
    <div className="experience" id="experience">
        ...
        <p>
            ...
            novel techniques and create new algorithms from scratch.</li>
            <li>Perform statistical analysis and document the impact of machine learning models.</li>
        ...
        <p>
            ...
            <li>Key course modules:</li>
                <ul>
                    ...
                    <li>Principles of Electronics</li> 
